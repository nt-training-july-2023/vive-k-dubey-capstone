...
public class InputFieldsChecksUpdated {
    ...
    public final void checkEmailExistence(final String email)
            throws DataAlreadyExistsException {
        Optional<RegisterEntity> registerEntity = registerRepo.findByEmpEmail(email);
    ...
    public final void checkEmpIdExistence(final String empId)
      ...
      Optional<RegisterEntity> registerEntity = registerRepo.findByEmpId(empId);
        if (registerEntity.isPresent()) {
            String message = "employee with employee Id " + empId + " already exist.";
            throw new DataAlreadyExistsException(message);
        }
    }
    ...
    public final void checkEmpContactExistence(final String empContact)
            throws DataAlreadyExistsException {
      Optional<RegisterEntity> registerEntity = registerRepo.findByEmpContactNo(empContact);
        if (registerEntity.isPresent()) {
     ...
     */
//    public final void loginValidation(String empEmail, String password)
//            throws WrongInputException {
//      Optional<RegisterEntity> registerEntity = registerRepo.findByEmpEmail(empEmail);
//
...
//        if (!passwordEncoder.matches(decodedPassword, registerEntity.getEmpPassword())) {
